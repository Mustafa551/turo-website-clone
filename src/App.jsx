  ...
  return(
    <div className="container">
      <div className="heading">
        ...
        <h2 className="heading2">Explore the world's largest car sharing marketplace</h2>
...
export { App, Head2, Pooster, Body1 };
